<?php 
  ...
  $member = query("SELECT id, nama, email FROM anggota");
  $book = query("SELECT id, judul, penulis FROM buku");

  if(isset($_POST["tambah-peminjam"])){

    if(tambah_peminjam($_POST) > 0){

      $_SESSION["pemimjamDiTambahkan"] = true;
            ...
            <div class="col">
              ...
              <form action="" method="post">
                ...
                <div class="mb-2">
                  ...
                  <div id="passwordHelpBlock" class="form-text">
                    Tanggal peminjaman otomatis tertulis sesuai dengan tanggal dan wajtu perangkat.
                  </div>
                </div> 
                ...
                <div class="row mt-3 d-flex justify-content-between">
                  <div class="col text-end">
                    <button type="submit" class="btn btn-success" name="tambah-peminjam">
                      Tambah
                    </button>
                  </div>
                </div>
