...
<body>
    ...
    <div class="container-fluid d-flex p-0 position-relative">
      ...
      <section class="main mt-4 flex-fill">
        ...
        <div class="container position-relative mb-4" style="max-width: 70%;">
              ...
              <form action="" method="post" enctype="multipart/form-data">
                ...
                <div class="card">
                  <div class="card-header d-flex justify-content-between">
                    <h1 class="fs-3">Update Foto</h1>

                    <div class="col-md-4 text-end">
                      <a href="update_admin.php?id=<?= $result["id"] ?>">Ubah Data Diri</a>
                    </div>
                  </div>
                  <img src="../assets/icons/admin-card-dashboard.png" alt="Ubah Logo" width="150px" class="mx-auto my-3"/>
                  <div class="card-body">
                    <ul class="list-group list-group-flush">
                      <li class="list-group-item fw-bold">Nama</li>
                      <li class="list-group-item text-capitalize"><?= $result["nama"] ?></li>
                    </ul>
                    ...
                    <ul class="list-group list-group-flush mt-3">
                      <li class="list-group-item fw-bold">Phone</li>
                      <li class="list-group-item"><?= $result["phone"] ?></li>
                    </ul>
                  </div>

                  <div class="row px-4 mb-3 flex-column">
                    <!-- tombol -->
