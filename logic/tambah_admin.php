<?php 
  ...
  if(isset($_POST["tambah"])){
    ...
    if(tambah_admin($_POST) > 0){
      ...
      // set session tambah admin berhasil
      $_SESSION["tambahAdminBerhasil"] = true;
        ...
        <div class="container position-relative bg-white rounded p-3 mb-4" style="max-width: 80%;">
            ...
            <?php if(isset($_SESSION["emailTerdaftar"])) : ?>
              <div class="alert alert-danger alert-dismissible fade show" role="alert">
                ...
                <strong>Admin gagal ditambahkan!</strong> Email yang Anda masukkan sudah terdaftar.
              </div>
              <!-- hapus sesssion -->
              <?php unset($_SESSION["emailTerdaftar"]); ?>

            <!-- jika konfirmasi password salah -->
            <?php elseif(isset($_SESSION["passwordTidakSama"])) : ?>
              <div class="alert alert-danger alert-dismissible fade show" role="alert">
                <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                <strong>Admin gagal ditambahkan!</strong> Password konfirmasi tidak sesuai.
              </div>
              <!-- hapus sesssion -->
              <?php unset($_SESSION["passwordTidakSama"]); ?>

            <!-- password admin tidak tedaftar -->
            <?php elseif(isset($_SESSION["passwordTidakTerdaftar"])) : ?>
              <div class="alert alert-danger alert-dismissible fade show" role="alert">
                <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                <strong>Admin gagal ditambahkan!</strong> Password admin tidak terdaftar.
              </div>
              <!-- hapus sesssion -->
              <?php unset($_SESSION["passwordTidakTerdaftar"]); ?>

            <?php endif;?>

            <div class="col">
              <h1 class="fs-3">Add Admin</h1>
              <form action="" method="post">

                <div class="mb-2">
                  <!-- judul -->
                  <label for="nama" class="col-form-label">Nama Lengkap</label>
                  <input type="text" class="form-control" id="nama" name="nama" minlength="5" maxlength="255" autofocus required />
                </div>
                ...
                <div class="mb-2">
                  ...
                  <input type="number" class="form-control" id="phone" name="phone" maxlength="14" required />
                </div>            
                ...
                <div class="mb-2">
                  ...
                  <input type="password" id="confirm-password" name="confirm-password" class="form-control" required />
                   <span id="passwordHelpInline" class="form-text">
                      Konfirmasi password harus sesuai dengan yang Anda inputkan diatas.
                  </span>
                </div>
                ...
                <div class="row mt-3">
                  ...
                  <div class="col text-end">
                    <button type="submit" class="btn btn-success" name="tambah" style="min-width: 150px;">
                      Add Admin
                    </button>
                  </div>
                </div>
